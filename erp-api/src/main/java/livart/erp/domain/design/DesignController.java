...
public class DesignController {
    ...
    @PutMapping("/brand")
    @Operation(summary = "✅ 브랜드 소개 저장 & 수정 API, 토큰 O", description = "없으면 저장되고 이미 존재하면 수정되는 구조의 API")
    ...
    @Operation(summary = "✅ 제품 페이지 배너 저장 & 수정 API, 토큰 O", description = "없으면 저장되고 이미 존재하면 수정되는 구조의 API")
    ...
    @PutMapping("/interior")
    @Operation(summary = "✅ 전시장 안내 저장 & 수정 API, 토큰 O", description = "없으면 저장되고 이미 존재하면 수정되는 구조의 API")
    ...
    @Operation(summary = "✅ 메인 페이지 배너 저장 & 수정 API, 토큰 O", description = "없으면 저장되고 이미 존재하면 수정되는 구조의 API")
